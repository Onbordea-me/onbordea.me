    ...
    <div className="flex h-screen overflow-hidden font-['IBM Plex Sans'] bg-gray-900 text-gray-100">
      ...
      <div className={`flex-1 flex flex-col bg-gray-800 ${isSidebarOpen ? 'ml-15' : 'ml-20'} transition-all duration-300`}>
        ...
        <main className="bg-gray-800 p-6 rounded-lg shadow-inner flex flex-col gap-6 overflow-auto m-6">
                    ...
                    requests.map((request) => (
                      <tr key={request.id} className="border-t border-gray-700 hover:bg-gray-800">
                        ...
                        <td className="px-4 py-2">
                          <button
                            onClick={() => openEmployeeDetail({ employee: request.employee })}
          ...
          <div>
            <h3 className="text-lg font-semibold mb-2 text-teal-400">Tickets Resueltos</h3>
            <div className="overflow-auto">
              <table className="min-w-full text-sm bg-gray-900 border border-gray-700 rounded-lg shadow text-gray-200">
                <thead className="bg-gray-700 text-gray-100 font-semibold">
                  <tr>
      ...
      {showEditTicketModal && selectedTicket && (
        <div id="editTicketModal" className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md shadow-xl text-gray-100">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold text-teal-400">Editar Ticket</h2>
              <button onClick={() => { setShowEditTicketModal(false); setSelectedTicket(null); }} className="text-gray-400 hover:text-gray-200 text-2xl">&times;</button>
            </div>
            <form onSubmit={handleEditTicketSubmit} className="space-y-4">
              <div>
                ...
                <select id="editType" name="tipo" defaultValue={selectedTicket.type} className="w-full border border-gray-600 rounded px-3 py-2 bg-gray-700 text-gray-100 focus:outline-none focus:border-teal-500" required>
                  <option value="Onboarding">Onboarding</option>
                  <option value="Offboarding">Offboarding</option>
                  <option value="Mantenimiento">Mantenimiento</option>
                  <option value="Equipment Change">Equipment Change</option>
              ...
              <div>
                ...
                <select id="editStatus" name="estado" defaultValue={selectedTicket.status} className="w-full border border-gray-600 rounded px-3 py-2 bg-gray-700 text-gray-100 focus:outline-none focus:border-teal-500" required>
              ...
              <div>
                ...
                <textarea id="editMessage" name="mensaje" defaultValue={selectedTicket.message} rows="3" className="w-full border border-gray-600 rounded px-3 py-2 bg-gray-700 text-gray-100 focus:outline-none focus:border-teal-500" placeholder="Detalles adicionales del pedido..."></textarea>
              </div>
              <div className="flex justify-end space-x-2 pt-4">
